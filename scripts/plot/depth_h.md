...
DP_29779 <-  ggplot(avg_depth_29779, aes(x = CHR, y = DEPTH)) +
  geom_bar(stat = "identity", fill = "#AF2C8B") +
  labs(x = "",
       y = "Average Depth") +
...
ggsave("/storage/home/abc6435/SzpiechLab/abc6435/KROH/plots/depth_grid_h.png", DP, width = 15, height = 8, dpi=300)
```

## Run R Script as Job
```bash
nano plot_depth_h.bash
#!/bin/bash 
#SBATCH --nodes=1 
#SBATCH --ntasks=1 
#SBATCH --mem=300GB 
