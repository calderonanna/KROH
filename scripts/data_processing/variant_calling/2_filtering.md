...
bcftools filter \
    ...
    -Oz -o $vcf_dir/chKIWA_AMRE_HOWA_tags_auto_bi_qual_dp.vcf.gz

#ADR/ADF 
bcftools filter \
  -e 'FORMAT/ADF[*:1] < 2 || FORMAT/ADR[*:1] < 2' \
  --set-GTs . \
  $vcf_dir/chKIWA_AMRE_HOWA_tags_auto_bi_qual_dp.vcf.gz \
  -Oz \
  -o $vcf_dir/chKIWA_AMRE_HOWA_tags_auto_bi_qual_dp_adf_adr.vcf.gz 
```
