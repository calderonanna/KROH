...
work="/storage/group/zps5164/default/abc6435/KROH/data/slim/vcf/rec"
seed_value=$(shuf -i 1-10000 -n 1)

#Run SLiM script
$slim -p $scripts/rec.slim
...
paste $work/mut.temp $work/count.temp $work/rab.temp $work/h.temp >> $work/rec.results
...
sim_vcf="/storage/home/abc6435/SzpiechLab/abc6435/KROH/data/slim/vcf/rec/eggs"
eggs="/storage/home/abc6435/SzpiechLab/bin/EGGS/bin/eggs"
work="/storage/home/abc6435/SzpiechLab/abc6435/KROH/data/slim/vcf/rec/eggs"
...
grep "RAB = " $work/intergenic_rab.txt\
  | sed "s/RAB = //g" >> $work/rab.temp
yes "0.0" | head -n4 >> $work/h.temp
paste $work/mut.temp $work/count.temp $work/rab.temp $work/h.temp >> $work/rec_eggs.results
