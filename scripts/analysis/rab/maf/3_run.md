...
maf="/storage/home/abc6435/SzpiechLab/abc6435/KROH/data/angsd/maf/tv_ts"
rab="/storage/group/zps5164/default/abc6435/KROH/data/rab/tv_ts"
...
for neu in $neus; do
    for mut in $muts; do
        ...
        python3 $scripts/RABmafs.py --fileA $maf/hKIWA_derived.maf --fileB $maf/cKIWA_derived.maf --fileN $rab/${neu}.txt --fileM $rab/${mut}.txt --seed 654165 --psites 0.30 --iter 100 >> $rab/${neu}_rab.txt
