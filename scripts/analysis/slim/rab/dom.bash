...
work="/storage/group/zps5164/default/abc6435/KROH/data/slim/vcf/dom"
seed_value=$(shuf -i 1-10000 -n 1)

#Run SLiM script
$slim -p $scripts/dom.slim
...
yes "1.0" | head -n4 >> $work/h.temp
paste $work/mut.temp $work/count.temp $work/rab.temp $work/h.temp >> $work/dom.results
...
sim_vcf="/storage/home/abc6435/SzpiechLab/abc6435/KROH/data/slim/vcf/dom/eggs"
eggs="/storage/home/abc6435/SzpiechLab/bin/EGGS/bin/eggs"
work="/storage/home/abc6435/SzpiechLab/abc6435/KROH/data/slim/vcf/dom/eggs"
...
grep "RAB = " $work/intergenic_rab.txt\
  | sed "s/RAB = //g" >> $work/rab.temp
yes "1.0" | head -n4 >> $work/h.temp
paste $work/mut.temp $work/count.temp $work/rab.temp $work/h.temp >> $work/dom_eggs.results
