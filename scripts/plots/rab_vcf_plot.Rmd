...
```{bash}
rsync abc6435@submit.hpc.psu.edu:/storage/home/abc6435/SzpiechLab/abc6435/KROH/data/rab/vcf/results.txt ~/Desktop/KROH/data/rab
```
...
rab_plot <- 
  ...
  geom_text(aes(label=N_SITES), x=-2, hjust=0, size=3) + 
...
ggsave("rab_vcf_plot.png", plot=rab_plot, 
