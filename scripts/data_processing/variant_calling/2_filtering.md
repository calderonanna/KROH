...
#Set Variables
scripts="/storage/home/abc6435/SzpiechLab/abc6435/KROH/scripts"
nano $scripts/filter_variants_downsampled.bash
#!/bin/bash
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=10GB
...
#Add All Tags
bcftools +fill-tags \
    $work/KIWA_dowsampled.vcf.gz \
    -Oz -o $work/KIWA_dowsampled_tags.vcf.gz \
    -- -t all

#Index
bcftools index \
    $work/KIWA_dowsampled_tags.vcf.gz
...
bcftools view \
    -r $chr_list \
    $work/KIWA_dowsampled_tags.vcf.gz \
    -Oz -o $work/KIWA_dowsampled_tags_auto.vcf.gz

#Sites: Biallelic 
bcftools view \
    -m2 -M2 -v snps \
    $work/KIWA_dowsampled_tags_auto.vcf.gz \
    -Oz -o $work/KIWA_dowsampled_tags_auto_bi.vcf.gz
```
