...
```{bash}
rsync abc6435@submit.hpc.psu.edu:/storage/home/abc6435/SzpiechLab/abc6435/KROH/data/pixy/intergenic/intergenic_2pops_pi.txt /Users/abc6435/Desktop/KROH/data/pixy
```
...
pi <- read.table("intergenic_2pops_pi.txt", header = TRUE)
pi <- na.omit(pi)
```
