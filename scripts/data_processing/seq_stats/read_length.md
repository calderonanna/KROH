...
for i in `cat $scripts_folder/cKIWA_IDS.txt`; do samtools view $data_folder/bam/${i}_marked.bam | awk '{print length($10)}' >> $data_folder/seq_stats/${i}_readlength.txt; done 
```
