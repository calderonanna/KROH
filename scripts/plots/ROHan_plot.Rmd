...
nroh_sroh_plot <- 
  ...
  facet_wrap(~hmm_posterior_decoding, scales = "free_x", ncol = 1) +
  xlab("SROH (Mb)") +
  ylab("NROH") +
  theme(
    panel.background = element_blank(),
...
ggsave(filename = "roh_theta_plot.png",
       plot = roh_theta_plot, 
       width = 5,
       height = 5,
       units = "in",
...
ggsave(filename = "nroh_sroh_plot.png",
       plot = nroh_sroh_plot, 
       width = 2,
       height = 6,
       units = "in",
